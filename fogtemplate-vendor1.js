...
gsap.set(".lazy", {autoAlpha:0, y: 300});
...
ScrollTrigger.batch(".lazy", {
  ...
  onLeave: batch => gsap.set(batch, {autoAlpha:0, y: -300, overwrite: true}),
  onEnterBack: batch => gsap.to(batch, {autoAlpha:1, y: 0, stagger: 0.15, overwrite: true}),
  onLeaveBack: batch => gsap.set(batch, {autoAlpha:0, y: 300, overwrite: true})
